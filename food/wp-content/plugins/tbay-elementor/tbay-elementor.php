...
define( 'TBAY_ELEMENTOR_VERSION', '1.0.6');
 ...
 *
 */
if ( !class_exists( 'ReduxFramework' ) && file_exists( TBAY_ELEMENTOR_DIR . 'libs/redux/ReduxCore/framework.php' ) ) {
    require_once( TBAY_ELEMENTOR_DIR . 'libs/redux/ReduxCore/framework.php' );
